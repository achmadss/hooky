...
Request Capture handles the ingestion and storage of all incoming HTTP requests to webhook endpoints. It captures complete request data including method, headers, query parameters, body, and metadata.
