# Capability: Response Configuration

## Overview

Response Configuration allows users to define custom HTTP responses for their webhook endpoints. When external services send requests to a webhook, Hooky returns the configured response.
