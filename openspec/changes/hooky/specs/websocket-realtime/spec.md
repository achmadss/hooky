# Capability: WebSocket Real-Time

## Overview

WebSocket Real-Time provides live streaming of captured webhook requests to connected clients. This enables developers to see incoming requests immediately without refreshing the page.
